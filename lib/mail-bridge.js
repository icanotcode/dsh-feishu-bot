...
export const mailTools = [
  ...
  { name: 'feishu_mail_discover', description: 'Automatically research the currently bound user’s unknown mailbox provider using public service-discovery records and official autoconfiguration, then verify TLS without credentials. Call once when mailbox status is awaiting_discovery. No domain, URL, server or credential arguments; never ask users for SMTP parameters. Report the returned next step; do not retry in a loop.', parameters: object({}) },
