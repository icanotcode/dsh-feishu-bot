...
const PUBLIC_FIELDS = ['connectionMode', 'tunnelProvider', 'workspacePath', 'agentPreset', 'permissionPreset', 'ngrokDomain', 'publicBaseUrl', 'authorizedUsers', 'capabilityDefaultRoles', 'dailyResetHour', 'dailyResetTimezone', 'tunnelAutoRestart', 'ngrokTrafficPolicyFile', 'ngrokExecutablePath', 'cloudflareExecutablePath', 'cloudflareMode', 'cloudflareTunnelName', 'cloudflareConfigFile'];
