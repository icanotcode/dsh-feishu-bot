  ...
  async function receive(delivery, signal) {
    ...
    return serial(key, async () => {
      ...
      try {
        ...
        if (mailReply.handled) { await commandReply(mailReply.reply); return null; }
        ...
        pending.set(parsed.messageId, { binding, messageId: parsed.messageId, finished: false, chatType: parsed.chatType });
