...
| Personal email sending | Enter your mailbox in a direct chat, automatically match known SMTP providers, verify your authorization code, and continue the current send request; custom servers and workspace attachments supported; no inbox access |
